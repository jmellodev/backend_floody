...
const RestauranSchema = new mongoose.Schema({
  ...
  verification: { type: String, default: "Pendente", enum: ["Pendente", "Verificado", "Rejeitado"] },
  verificationMessage: { type: String, default: "Seu restaurante está em análise. Iremos notificá-lo assim que for verificado." },
  coords: {
    id: { type: String },
